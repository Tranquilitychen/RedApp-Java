...
public class VoRoom {
    ...
    public String getBookingnno() {
        return bookingnno;
    }

    public void setBookingnno(String bookingnno) {
        this.bookingnno = bookingnno;
    }
